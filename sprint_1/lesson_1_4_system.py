...
def main() -> None:
    load_dotenv()
    system_instruction = (
        "You are an expert AI assistant. Follow the system persona instructions carefully. "
        "Respond helpfully and clearly to the user input."
    )
    ...
    print("System-instruction chat. Type 'exit' or 'quit' to stop.")
    while True:
